...
/*
 * Created by VSkurikhin 28.11.18 23:41.
 * ObjectFactory.java
 * $Id$
...
public class ObjectFactory {
    ...
    private final static QName _GetAvgSalaryResponse_QNAME = new QName("http://salary.wservice.soap.otus.ru/", "getAvgSalaryResponse");
    private final static QName _GetMaxSalary_QNAME = new QName("http://salary.wservice.soap.otus.ru/", "getMaxSalary");
    private final static QName _GetAvgSalary_QNAME = new QName("http://salary.wservice.soap.otus.ru/", "getAvgSalary");
    private final static QName _GetMaxSalaryResponse_QNAME = new QName("http://salary.wservice.soap.otus.ru/", "getMaxSalaryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.otus.soap.wsclient.salary
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetAvgSalaryResponse }{@code >}}
     * 
     */
    ...
    public JAXBElement<GetAvgSalaryResponse> createGetAvgSalaryResponse(GetAvgSalaryResponse value) {
        return new JAXBElement<GetAvgSalaryResponse>(_GetAvgSalaryResponse_QNAME, GetAvgSalaryResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetMaxSalary }{@code >}}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetAvgSalary }{@code >}}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetMaxSalaryResponse }{@code >}}
     * 
     */
    ...
    public JAXBElement<GetMaxSalaryResponse> createGetMaxSalaryResponse(GetMaxSalaryResponse value) {
        return new JAXBElement<GetMaxSalaryResponse>(_GetMaxSalaryResponse_QNAME, GetMaxSalaryResponse.class, null, value);
    }
