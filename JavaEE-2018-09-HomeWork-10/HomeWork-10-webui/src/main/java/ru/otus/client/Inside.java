...
import ru.otus.client.aside.News;
import ru.otus.client.aside.CBRValutes;
import ru.otus.client.service.InsideServiceAsync;
import ru.otus.client.widget.AddView;
import ru.otus.client.widget.PayView;
import ru.otus.client.widget.SearchView;
...
import static ru.otus.shared.Constants.REQUEST_FOREX_RATES;
import static ru.otus.shared.Constants.REQUEST_NEWS;
...
public class Inside extends Welcome
{
    ...
    private void initMainContainer()
    {
        ...
        deckPanel.add(new PayView(service, this));
        deckIndexPayView = deckPanel.getWidgetCount() - 1;
