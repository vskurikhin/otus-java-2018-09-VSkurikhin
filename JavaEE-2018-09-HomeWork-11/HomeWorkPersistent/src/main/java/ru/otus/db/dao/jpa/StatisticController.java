...
public class StatisticController extends AbstractController<StatisticEntity, Long> implements StatisticDAO
{
    ...
    {
        return findAll(StatisticEntity.class);
    }

    @Override
    @TransactionAttribute(SUPPORTS)
    public StatisticEntity findEntityById(Long id)
    {
        return findEntityViaClassById(id, StatisticEntity.class);
    }
    ...
    @Override
    @TransactionAttribute(REQUIRES_NEW)
    public boolean create(StatisticEntity entity)
    {
    ...
    @Override
    @TransactionAttribute(REQUIRES_NEW)
    public long insertProcedure(StatisticEntity entity)
    {
