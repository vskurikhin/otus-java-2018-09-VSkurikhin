...
public interface TestDBConf
{
    ...
    Map<String, String> FILE_LOCATIONS = new HashMap<String , String>() {{
        put(TBL_DEPT_DIRECTORY, TEST_RESOURCES + "DeptEntities.xml");
        put(TBL_EMP_REGISTRY,  TEST_RESOURCES + "EmpEntities.xml");
        put(TBL_STATISTIC,     TEST_RESOURCES + "StatisticEntities.xml");
        put(TBL_USER_GROUPS,   TEST_RESOURCES + "UsersgroupEntities.xml");
        put(TBL_USERS,         TEST_RESOURCES + "UserEntities.xml");
    }};
